...
test_that("po2_param_check raises warning on low value", {
  po2s_kpa = 0.5
  expect_warning(po2_param_check(po2s_kpa, po2_units = "kPa"))
  po2s_kpa = c(5,5,5,0.5)
  expect_warning(po2_param_check(po2s_kpa, po2_units = "kPa"))
  pco2s_mmHg = 3
  expect_warning(po2_param_check(pco2s_mmHg, po2_units = "mmHg"))
})
...
test_that("po2_param_check raises warning on high value", {
  ...
  expect_warning(po2_param_check(po2s_kpa, po2_units = "kPa"))
  po2s_kpa = 86
  expect_failure(expect_warning(po2_param_check(po2s_kpa, po2_units = "kPa")))
