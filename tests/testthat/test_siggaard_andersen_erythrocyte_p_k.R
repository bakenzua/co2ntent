...
test_that("siggaard_andersen_erythrocyte_p_k returns correct number", {
  expect_equal(co2ntent:::siggaard_andersen_erythrocyte_p_k(0.9), 6.046073, tolerance=0.000001)
})
...
test_that("siggaard_andersen_erythrocyte_p_k is vectorised", {
  ...
  expect_equal(co2ntent:::siggaard_andersen_erythrocyte_p_k(so2_fraction=so2s), expected, tolerance=0.000001)
})
