...
test_that("siggaard_andersen_plasma_bicarbonate_content_mmol_l returns correct number", {
  expect_equal(co2ntent:::siggaard_andersen_plasma_bicarbonate_content_mmol_l(
    pco2=5,
    ph=7.4,
    temperature=37, 
    pco2_units = "kPa"
  ...
  expect_equal(co2ntent:::siggaard_andersen_plasma_bicarbonate_content_mmol_l(pco2=5), 22.846537295717454, tolerance=0.000001)
})
...
test_that("siggaard_andersen_plasma_bicarbonate_content_mmol_l is vectorised", {
  ...
  expect_equal(co2ntent:::siggaard_andersen_plasma_bicarbonate_content_mmol_l(pco2=pco2s), expected, tolerance=0.000001)
})
