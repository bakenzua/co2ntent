...
`std_kelman_po2_to_so2(po2, po2_units = c("kPa", "mmHg"))`
...
`kelman_virtual_po2(po2, pco2, temperature = 37, ph = 7.4, po2_units = c("kPa", "mmHg"))`
...
`kelman_po2_to_so2(po2, temperature = 37, ph = 7.4, pco2 = 5.332895, po2_units = c("kPa", "mmHg"))`
...
* temperature	- temperature in celcius. Default 37c
* ph - pH (hydrogen ion concentration). Default 7.40
* po2_units - Input parameters are kPa, otherwise use mmHg. Default kPa

### po2_to_so2

`po2_to_so2(po2, temperature = 37, ph = 7.4, pco2 = 5.332895, po2_units = c("kPa", "mmHg"))`
