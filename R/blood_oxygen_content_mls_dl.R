...
#' on author/literature source or c. This function uses a value of 1.31 ml/g as per \insertCite{lumb_nunns_2010}{co2ntent}.
...
#' @param hufners_constant Oxygen capacity of human haemoglobin. Default 1.31 ml/g
